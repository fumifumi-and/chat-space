   ...
   if ( message.image ) {
     var html =
      `<div class="chat-main__message-list__message" data-message-id=${message.id}>
         <div class="chat-main__message-list__message__wrapper">
           <div class="uhat-main__message-list__message__wrapper__user">
             ${message.user_name}
           </div>
           <div class="chat-main__message-list__message__wrapper__date">
             ${message.created_at}
           </div>
         </div>
